...
full_abbr_province_dict = {'北京市':'京','浙江省':'浙','天津市':'津', '安徽省':'皖','上海市':'沪','福建省':'闽','重庆市':'渝','江西省':'赣','香港特别行政区':'港','山东省':'鲁','澳门特别行政区':'澳' ,'河南省': '豫', '内蒙古自治区':'蒙','湖北省':'鄂', '新疆维吾尔自治区':'新', '湖南省':'湘','宁夏回族自治区':'宁','广东省':'粤','西藏自治区':'藏','海南省':'琼', '广西壮族自治区':'桂','四川省':'川','河北省':'冀','贵州省':'贵','山西省': '晋','云南省':'云','辽宁省':'辽','陕西省':'陕','吉林省':'吉','甘肃省':'甘','黑龙江省':'黑','青海省':'青','江苏省':'苏'}
